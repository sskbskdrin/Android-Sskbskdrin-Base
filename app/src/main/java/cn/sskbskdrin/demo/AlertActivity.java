 ...
 */
public class AlertActivity extends Activity implements OnItemClickListener, OnDismissListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAlertView = new AlertView("标题", "内容", "取消", new String[]{"取消", "选择","确定"}, null, this, AlertView.Style.Alert, this).setCancelable(true).setOnDismissListener(this);
		//拓展窗口
	...
	public void alertShow4(View view) {
		new AlertView("标题", null, "取消", new String[]{"高亮按钮1", "高亮按钮2"}, new String[]{"其他按钮1", "其他按钮2", "其他按钮3"}, this, AlertView.Style.ActionSheet, this).show();
	}
